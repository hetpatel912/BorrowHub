...
<html>
<head>
    <title>Receiver Dashboard - BorrowHub</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<div class="main-content">
    ...
    <div class="dashboard-grid">
        ...
        <div class="card">
            ...
            <p>Browse all resources available for borrowing.</p>
            <a href="ViewAvailableResources"><button class="card-btn">Browse Resources </button></a>
        </div>
        ...
        <div class="card">
            ...
            <a href="MyRequestsServlet"><button class="card-btn">View Requests </button></a>
        </div>
    </div>
